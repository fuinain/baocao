...
<input type="Email-l" id="Email-l" name="email" value="Tài khoản của bạn " onBlur="if(this.value=='')this.value='Tài khoản của bạn '" onFocus="if(this.value=='Tài khoản của bạn ')this.value=''"></p>
...
<li><a href="#">Dành cho nhóm mua</a></li>
 <li><a href="#">Dành cho nhà cung cấp</a></li>
  <li><a href="#">Về ShopPhone.VN</a></li>
