              ...
              <div class="tabcontents">
                <div id="payment-at">
                  <div class="content-payment spen-plus">
                    ...
                    <p><form action="/vnpayment" method="post">
              <input type="hidden" name="amount" value=<?=  (int)$total + $up ?>>


                          <button type="submit" class="vn-pay" href="/vnpayment" name="redirect">Thanh toán bằng VNpay </button>
                          </form>
                        </p>
                        <p>(*) Tôi đã đồng ý với điều khoản của ShopPhone.VN </p>
