            ...
            <div class="card-header">Người dùng
                <div class="tools dropdown">
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="/admin/user/create">Thêm</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-striped table-borderless">
                    <thead>
                        <tr>
                            ...
                            <th style="width:30%;">Phân quyền</th>
                    ...
                    <tbody class="no-border-x">
                        ...
                        <?php foreach ($data as $item) : ?>
                            <tr>
                                <td><label> <?= $i; ?> </label></td>
                                <td><label> <?= $item->login_id; ?> </label></td>
                                <td><label> <?= $item->firstname ?></label></td>
                                <td><label> <?php if($item->role == 1) { echo'admin'; } else if ($item->role == 2){ echo'quản trị viên';} else { echo'khách hàng'; } ?> </label></td>
                                <?php if($item->role !== 1){ ?>
                                ...
                                <?php } ?>
                                <td style="width:60px" class="actions"><a class="btn btn-primary btn-sm" href="/admin/user/edit?id=<?= $item->id ?>">Sửa</a></td>
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="mt-8">
                            ...
                            <a href="/admin/user/destroy?id=<?= $item->id ?>" class="btn btn-space btn-danger">Đồng ý</a>
                        </div>
                    </div>
                </div>
