            ...
            <div class="container-fluid">
                ...
                <div class="be-right-navbar">
                    <ul class="nav navbar-nav float-right be-user-nav">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="/assets/img/avatar.png" alt="Avatar"></a>
                            <div class="dropdown-menu" role="menu">
                                <div class="user-info">
                                    <!-- <div class="user-name">Túpac Amaru</div> -->
                                    <div class="user-position online">Đang hoạt động</div>
                                </div><a class="dropdown-item" href="/user"><span class="icon mdi mdi-face"></span>Thông tin cá nhân</a><a class="dropdown-item" href="/logout?rd=3"><span class="icon mdi mdi-power"></span>Đăng xuất</a>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="left-sidebar-scroll">
                        <div class="left-sidebar-content">
                            <ul class="sidebar-elements">
                                ...
                                <li><a href="/user"><i class="icon mdi mdi-view-web"></i><span>Thông tin cá nhân</span></a>
                                </li>
                                <li><a href="/user/showDetail"><i class="icon mdi mdi-home"></i><span>Đơn hàng</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
