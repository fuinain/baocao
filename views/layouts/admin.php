        ...
        <nav class="navbar navbar-expand fixed-top be-top-header">
            <div class="container-fluid">
                <div class="be-navbar-header">
                    ...
                    <a href="/" style="font-size:18px; margin-left: 22px; color: gray">PhoneShop</a>
                </div>
                    ...
                    <ul class="nav navbar-nav float-right be-user-nav">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="/assets/img/avatar.png" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
                            <div class="dropdown-menu" role="menu">
                                <div class="user-info">
                                    <div class="user-name"><?=Application::$app->session->get('user_')->firstname?></div>
                                    <div class="user-position online">Online</div>
                                </div><a class="dropdown-item" href="/admin/Information"><span class="icon mdi mdi-face"></span>Thông tin người quản trị</a><a class="dropdown-item" href="/logout?rd=1"><span class="icon mdi mdi-power"></span>Đăng xuất</a>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="be-left-sidebar">
            <div class="left-sidebar-wrapper"><a class="left-sidebar-toggle" href="#">Tổng quan</a>
                    ...
                    <div class="left-sidebar-scroll">
                        <div class="left-sidebar-content">
                            <ul class="sidebar-elements">
                                ...
                                <li><a href="/admin/dashboard"><i class="icon mdi mdi-home"></i><span>Tổng quan</span></a>
                                </li>
                                <li><a href="/admin/Information"><i class="icon mdi mdi-face"></i><span>Thông tin người dùng</span></a>
                                </li>
                                <li><a href="/admin/orderdetails"><i class="icon mdi mdi-view-web"></i><span>Đơn hàng</span></a>
                                </li>
                                <li><a href="/admin/products"><i class="icon mdi mdi-view-web"></i><span>Sản phẩm</span></a>
                                </li>
                                <li><a href="/admin/categories"><i class="icon mdi mdi-view-web"></i><span>Hãng sản xuất</span></a>
                                </li>
                                <li><a href="/admin/user"><i class="icon mdi mdi-view-web"></i><span>Tài khoản</span></a>
                                </li>
                                <li><a href="/admin/post"><i class="icon mdi mdi-view-web"></i><span>Bài đăng</span></a>
                                </li>
                                <li><a href="/admin/user/reset-password"><i class="icon mdi mdi-view-web"></i><span>Đặt lại mật khẩu</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <!-- <div class="progress-widget">
                    <div class="progress-data"><span class="progress-value">100%</span><span class="name">Current Project</span></div>
                    <div class="progress">
